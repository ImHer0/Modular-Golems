...
execute at @s run kill @e[type=item,nbt={Item:{id:"minecraft:Block_of_Resin",count:1}},sort=nearest,limit=1]
...
data merge entity @s {Health:95f,attributes:[{id:"minecraft:max_health",base:95.0},{id:"minecraft:armor",base:5.0},{id:"minecraft:attack_damage",base:14.0}],DeathLootTable:"mgolems:entities/resin_golem",mg_resin:1b,equipment:{chest:{id:"minecraft:Block_of_Resin",count:1}},drop_chances:{chest:0.000}}
