# Validates and spawns Z-axis FLAT INVERTED super golem at THIS position (pumpkin location)
...
function mgolems:golemspawns/super_golem/summon_golem {x:0,y:0,z:-1}
