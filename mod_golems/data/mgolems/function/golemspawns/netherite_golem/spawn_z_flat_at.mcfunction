...
execute unless block ~ ~ ~1 minecraft:netherite_block run return fail
...
particle block{block_state:"minecraft:netherite_block"} ~ ~ ~1 0.5 0.5 0.5 0.1 60 normal
...
function mgolems:golemspawns/netherite_golem/summon_golem {x:0,y:0,z:1}
